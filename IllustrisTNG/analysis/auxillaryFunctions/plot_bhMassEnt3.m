function plot_massEnt3(option,xx,yy,cc,treeSt,barLab,cmap,xl,yl,popCont,qCont,sfCont,gasField,cax,hostm,noYLab)
...
if strcmp(gasField,'Out') || strcmp(gasField,'Sub')
    global cosmoStruct
    kk=mass_entropy_relation(10.^hostm.yMedian,'cosmo',cosmoStruct);
    plot(hostm.xMedian,log10(kk),'k--','linewidth',lw)
end
