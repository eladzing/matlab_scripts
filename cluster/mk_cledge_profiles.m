...
figure
    ...
    %printout_fig(gcf,sprintf(name,'ent',aexp))
    %pause
 figure
 ...
 loglog(rroo,too,'linewidth',2);
    ...
    %printout_fig(gcf,sprintf(name,'temp',aexp))
    ...
    fac=Ms/mm/Mpc^3;
 loglog(rroo,roo.*fac,'linewidth',2);
    ylim([0.5e-6 0.05]);   
    xlim(xl);
    grid
    hold on
   ...
   printout_fig(gcf,sprintf(name,'rho',aexp))