...
for i=1:5
    ...
    xlim(xl);ylim(yl);
		 xlabelmine(bhLab2,18);
    ylabelmine(tcLab);
    set(gca,'Fontsize',18)
    
    fname=sprintf('bhMassTcool_%s',nameTag);
    ...
    fname=sprintf('bhMassTemp_%s',nameTag);
    if  printFlag; printout_fig(gcf,fname,'fig','v'); end
    ...
    fname=sprintf('bhMassTemp2_%s',nameTag);
    if  printFlag; printout_fig(gcf,fname,'fig','v'); end
    ...
    set(gca,'Fontsize',18)
    fname=sprintf('bhMassDens_%s',nameTag);
    if  printFlag; printout_fig(gcf,fname,'fig','v'); end
    ...
    set(gca,'Fontsize',18)
    fname=sprintf('bhMassgasFrac_%s',nameTag);
    if  printFlag; printout_fig(gcf,fname,'fig','v'); end
    %% entropy
    yl=[-2 2.5];
    ...
    fname=sprintf('bhMassEnt_%s',nameTag);
    if  printFlag; printout_fig(gcf,fname,'fig','v'); end
