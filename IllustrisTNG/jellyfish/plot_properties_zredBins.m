...
zBin=discretize(zreds,zredBins);
...
%            xl=xl0;yl=yl0;
            ...
            popContJF0=plot_population_contour(xxJF,yyJF,'smooth',filt,'noplot',...
                'xlim',xl,'ylim',yl);
                        
            msk=zb==1;
            popContJF(1)=plot_population_contour(xxJF(msk),yyJF(msk),'smooth',filt,'noplot',...
                'xlim',xl,'ylim',yl);
            msk=zb==2;
            popContJF(2)=plot_population_contour(xxJF(msk),yyJF(msk),'smooth',filt,'noplot',...
                'xlim',xl,'ylim',yl);
...
%             
           ...
           % imagesc(xl,yl,squeeze(bird(:,:,1)))
            ...
            hold on
            [~,h(2)]=contour(popContJF(1).xx,popContJF(1).yy,popContJF(1).popContour,'ShowText','off','LineColor',[0 0 1],...
           ...
           [~,h(2)]=contour(popContJF(2).xx,popContJF(2).yy,popContJF(2).popContour,'ShowText','off','LineColor',[0 0 1],...
                'LineColor','g','linewidth',2,...
                'LevelList',[99 75:-25:5],'Fill','off','linestyle','-',...
                'DisplayName','Jellyfish');
           clabel([],h(2),'fontsize',14,'margin',5,'backgroundcolor','none');
           msk=zb==3;
             plot(xxJF(msk),yyJF(msk),'^',...
