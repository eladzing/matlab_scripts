...
subplot(4,2,1);
semilogx(rp,mdf','linewidth',1);grid;xlim(xl);ylim([-0.29 0.15]);
...
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[-0.3 -0.2 -0.1 0 0.1 0.2],'YMinorGrid','off','Fontsize',12,'linewidth',1,...
...
v1=std(mdf,0,1);%v2=std(mdf2,0,1);
fl1s=smooth(fl1,8);
uls=smooth(fl1+v1./2,8);
lls=smooth(fl1-v1./2,8);

subplot(4,2,2);
semilogx(rp,fl1s,'-b','linewidth',2);
hold on
semilogx(rp,uls,'--b','linewidth',2);
semilogx(rp,lls,'--b','linewidth',2);
grid;xlim(xl);ylim([-0.29 0.15]);hold on;
%semilogx(rp,fl1,'-b','linewidth',2);grid;xlim(xl);ylim([-0.3 0.15]);hold on;
...
line([0.2 0.2],[-1e5 1e5],'Color',[0.2 0.8 0.2],'LineWidth',2);
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[-0.3 -0.2 -0.1 0 0.1 0.2],'YMinorGrid','off','xticklabel','','yticklabel','','Fontsize',12,'linewidth',1,...
    'Position',[0.57 0.77 0.42 0.21]);

%figure;
subplot(4,2,3);
loglog(rp,tp','linewidth',1);grid;xlim(xl);ylim([5e-2 7]);
line([0.2 0.2],[1e-5 1e5],'Color',[0.2 0.8 0.2],'linewidth',2);
%xlabel('$r/R_{\mathrm{vir}}$','Fontsize',12);
ylabelmine('$T/T_{\mathrm{vir}}$');
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e-1 1 1e1],'YMinorGrid','off','xticklabel','','Fontsize',12,'linewidth',1,...
...
%figure;
subplot(4,2,4);
loglog(rp,fl1s,'-b','linewidth',2);
hold on
loglog(rp,uls,'--b','linewidth',2);
loglog(rp,lls,'--b','linewidth',2);
%loglog(rp,fl1,'-b','linewidth',2);
%loglog(rp,[fl1-v1./2;fl1+v1./2],'-.b','linewidth',1.5);%grid;xlim([1e-3 10]);ylim([-3 1]);
grid;xlim(xl);ylim([5e-2 7]);
line([0.2 0.2],[1e-5 1e5],'Color',[0.2 0.8 0.2],'linewidth',2);
hold off;
%xlabel('$r/R_{\mathrm{vir}}$','Fontsize',12);
%ylabel('$T/T_{\mathrm{vir}}$','Fontsize',12,'Interpreter','latex');
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e-1 1 1e1],'YMinorGrid','off','xticklabel','','yticklabel','','Fontsize',12,'linewidth',1,...
...
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e-2 1 1e2 ],'YMinorGrid','off','xticklabel','','Fontsize',12,'linewidth',1,...
...
grid;xlim(xl);ylim([1e-3 1e2])
line([0.2 0.2],[1e-5 1e5],'Color',[0.2 0.8 0.2],'linewidth',2);
hold off;
%xlabel('$r/R_{\mathrm{vir}}$','Fontsize',12);
%ylabel('$\rho_{gas}/\rho_{\mathrm{vir}}$','Fontsize',12);
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e-2 1 1e2],'YMinorGrid','off','xticklabel','','yticklabel','','Fontsize',12,'linewidth',1,...
...
%set(gca,'XTick', [1e-2 1e-1 1 3],'YTick',[1e-1 1 1e1],'Fontsize',12,'linewidth',1,...
set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e1 1e2 1e3 1e4],'YMinorGrid','off','Fontsize',12,'linewidth',1,...
...
%loglog(rp,[fl1-v1./2;fl1+v1./2],'-.b','linewidth',1);%grid;xlim([1e-3 10]);ylim([-3 1]);
grid;xlim(xl);ylim([1e1 1e4]);
line([0.2 0.2],[1e-5 1e5],'Color',[0.2 0.8 0.2],'linewidth',2);
hold off;
xlabelmine('$r/R_{\mathrm{vir}}$')
%ylabel('$S/S_{\mathrm{vir}}$','Fontsize',12);

set(gca,'XTickLabelMode','Auto','Xtick',[1e-1 1 10],'YTick',[1e1 1e2 1e3 1e4],'YMinorGrid','off','yticklabel','','Fontsize',12,'linewidth',1,...
