...
for hInd=[1 2 3 4 5 7] %1:length(mh)
    %% set Host parameters
...
%                     (k-1)*sz(2)+j,prod(sz))
        ...
        name=sprintf('catalogEvolved_Ms100_%s_host%s_fgs%s.mat',tags{kk},hostTags{hInd},simEmulate) ;
        ...
        name=sprintf('qFrac_Ms100_%s_host%s_fgs%s.mat',tags{kk},hostTags{hInd},simEmulate);
