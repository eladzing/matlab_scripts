...
catName=[DEFAULT_MATFILE_DIR '/yangSatSample_sig1_' virType '_' simDisplayName];
...
catName=[DEFAULT_MATFILE_DIR '/velSatSample_sig1_' virType '_' simDisplayName];
save(catName,'satTabX','satTabY','satTabZ');
...
catName=[DEFAULT_MATFILE_DIR '/zredSatSample_sig1_' virType '_' simDisplayName];
save(catName,'satTabX','satTabY','satTabZ');
