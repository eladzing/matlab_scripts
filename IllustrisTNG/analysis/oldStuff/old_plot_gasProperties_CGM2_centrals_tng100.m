...
tempLab='$\log T_{\mathrm{CGM}} \,[\mathrm{K}]$';
entLab='$\log S_{\mathrm{CGM}}\,[\mathrm{KeV\,cm^2}]$';
...
popCont=plot_population_contour(xdata,ydata,'smooth',filt,'noplot','xxlim',[9 12.5],'yylim',[4 8]);
yl=[4 8];
xl=[9 12.5];
...
% fname=sprintf('massTemp_%s_CGM_centrals_%s','ssfr',simDisplayName);
...
% ax2.Visible = 'off';ax2.XTick = [];ax2.YTick = [];
% 
% fname=sprintf('massTemp_%s_CGM_centrals_%s','sfre',simDisplayName);
% printout_fig(gcf,fname);
...
fname=sprintf('massTemp_%s_CGM_centrals_%s','tcool',simDisplayName);
printout_fig(gcf,fname);
...
% 
% 
% fname=sprintf('massTemp_%s_CGM_centrals_%s','mf',simDisplayName);
% printout_fig(gcf,fname);
...
fname=sprintf('massTemp_%s_CGM_centrals_%s','QM',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massTemp_%s_CGM_centrals_%s','KM',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massTemp_%s_CGM_centrals_%s','bhRat',simDisplayName);
printout_fig(gcf,fname);
...
% ax2.Visible = 'off';ax2.XTick = [];ax2.YTick = [];
% 
% fname=sprintf('massEnt_%s_CGM_centrals_%s','ssfr',simDisplayName);
% printout_fig(gcf,fname);
% 
% % sfre
% figure
...
% ax2.Visible = 'off';ax2.XTick = [];ax2.YTick = [];
% 
% fname=sprintf('massEnt_%s_CGM_centrals_%s','sfre',simDisplayName);
% printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_CGM_centrals_%s','tcool',simDisplayName);
printout_fig(gcf,fname);
...
% ax2.Visible = 'off';ax2.XTick = [];ax2.YTick = [];
% 
% fname=sprintf('massEnt_%s_CGM_centrals_%s','mf',simDisplayName);
% printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_CGM_centrals_%s','QM',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_CGM_centrals_%s','KM',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_CGM_centrals_%s','bhRat',simDisplayName);
printout_fig(gcf,fname);
