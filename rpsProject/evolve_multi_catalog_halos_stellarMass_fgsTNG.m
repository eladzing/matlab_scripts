...
for hInd=[1 2 3 4 5 6 7]  %1:length(mh)
    %% set Host parameters
    ...
    for kk=kstart(hInd):kend(hInd)
        ...
        %name=sprintf('catalog_fg1_bet05_%s_ng100.mat',tags{kk});
...
%                     (k-1)*sz(2)+j,prod(sz))
        ...
        name=sprintf('catalogEvolved_Ms100_%s_host%s_fgs%s_snp%s.mat',tags{kk},hostTags{hInd},simEmulate,num2str(snap)) ;
        ...
        name=sprintf('qFrac_Ms100_%s_host%s_fgs%s_snp%s.mat',tags{kk},hostTags{hInd},simEmulate,num2str(snap));
