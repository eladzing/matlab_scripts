...
w = 2016;              % Initial extrapolation target
z = 340;               % Eyeball extrapolation
...
ax = axis;
set(h.extrap,'pos',[w,min(max(z+30,30),ax(4)-30)], ...
    'vis','on', ...
...
% ------------------------------------------------
    ...
    function info_cb(varargin)
        web('http://blogs.mathworks.com/cleve/2017/01/05/fitting-and-extrapolating-us-census-data', ...
            '-notoolbar'); 
    end
