    ...
    for i=1:length(hostTags)
        ...
        for j=1:length(tags)
            ...
            if j==1
                ...
                qfHost(i).qfR1=qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).qf;
                qfHost(i).cntR1=qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).cnt;
                
                qfHost(i).qfRF=qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).qf;
                qfHost(i).cntRF=qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).cnt;
                
                qfHost(i).qfR1P=qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).qfProj;
                qfHost(i).cntR1P=qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).cntProj;
                
                qfHost(i).qfRFP=qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).qfProj;
                qfHost(i).cntRFP=qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).cntProj;
                
%                 qfHost(i).qfRFP =qfHost(i).(sprintf('qf%s',tag2{j})).massRatSFull(betaInd).qfProj;
%                 qfHost(i).cntRFP=qfHost(i).(sprintf('qf%s',tag2{j})).massRatSFull(betaInd).cntProj;
%                                
                
                
                qfHost(i).bcen=qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).bCen-0.25;
            else
                
                if ~isempty(qfHost(i).(sprintf('qf%s',tag2{j})))
                    
                                       
                    qfHost(i).qfR1 = qfHost(i).qfR1 + qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).qf;
                    qfHost(i).cntR1= qfHost(i).cntR1+ qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).cnt;
                    
                    qfHost(i).qfRF = qfHost(i).qfRF + qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).qf;
                    qfHost(i).cntRF= qfHost(i).cntRF+ qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).cnt;
                    
                    qfHost(i).qfR1P = qfHost(i).qfR1P + qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).qfProj;
                    qfHost(i).cntR1P= qfHost(i).cntR1P+ qfHost(i).(sprintf('qf%s',tag2{j})).r1Pass(betaInd).cntProj;
                    
                    qfHost(i).qfRFP = qfHost(i).qfRFP + qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).qfProj;
                    qfHost(i).cntRFP= qfHost(i).cntRFP+ qfHost(i).(sprintf('qf%s',tag2{j})).rFull(betaInd).cntProj;
...
%                     
        ...
        qfHost(i).qff=qfHost(i).qfRF./qfHost(i).cntRF;
        qfHost(i).qf1=qfHost(i).qfR1./qfHost(i).cntR1;
        
        qfHost(i).qffP=qfHost(i).qfRFP./qfHost(i).cntRFP;
        qfHost(i).qf1P=qfHost(i).qfR1P./qfHost(i).cntR1P;
...
%     end
    ...
    fname=sprintf('qf_comparison_ms_fgh_fgsTNG100_%s',ptag);
