...
for id1=1:length(bpz)
    for id2=1:length(bpx)
        ...
        %% make bores
        bro=mk_bore(ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        btm=mk_bore(tm,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bs=mk_bore(s,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bpre=mk_bore(pre,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bzt=mk_bore(zt,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        %bzt=mk_bore(zt,'dir','Y','xind',ind1,'zind',ind2);
        ...
        bvpar=mk_bore(vpar./get_vvir,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bvper1=mk_bore(vper1./get_vvir,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bvper2=mk_bore(vper2./get_vvir,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
        bvperT=mk_bore(vperTot./get_vvir,'weight',ro,'dir',dir,'zind',indz,'xind',indx,'smooth',smook);
    end
end
...
h(7)=semilogy(shkY(1).*[1 1],[0.01 100.0],':k','linewidth',2,...
    'DisplayName','Shock');
h(7)=semilogy(shkY(2).*[1 1],[0.01 100.0],':k','linewidth',2,...
    'DisplayName','Shock');
h(7)=semilogy(shkY(3).*[1 1],[0.01 100.0],':k','linewidth',2,...
    'DisplayName','Shock');
...
h(5)=semilogy(cfY(1).*[1 1],[-10.0 10.0],'--k','linewidth',2,...
    'DisplayName','CF');

h(6)=semilogy(shkY(1).*[1 1],[-10.0 10.0],':k','linewidth',2,...
    'DisplayName','Shock');
h(6)=semilogy(shkY(2).*[1 1],[-10.0 10.0],':k','linewidth',2,...
    'DisplayName','Shock');
h(6)=semilogy(shkY(3).*[1 1],[-10 10.0],':k','linewidth',2,...
    'DisplayName','Shock');
