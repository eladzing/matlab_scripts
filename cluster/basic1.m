function varargout = basic1(varargin)
% BASIC1 M-file for basic1.fig
%      BASIC1, by itself, creates a new BASIC1 or raises the existing
%      singleton*.
%
%      H = BASIC1 returns the handle to a new BASIC1 or the handle to
%      the existing singleton*.
%
%      BASIC1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BASIC1.M with the given input arguments.
%
%      BASIC1('Property','Value',...) creates a new BASIC1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before basic1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to basic1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help basic1

% Last Modified by GUIDE v2.5 27-Dec-2007 18:16:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @basic1_OpeningFcn, ...
                   'gui_OutputFcn',  @basic1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before basic1 is made visible.
function basic1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to basic1 (see VARARGIN)

% Choose default command line output for basic1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes basic1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = basic1_OutputFcn(hObject, eventdata, handles) 
