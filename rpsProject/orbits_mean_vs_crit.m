...
vv1=orbParam.mh1e12.mr05.vv;
vv2=orbParam.mh5e12.mr05.vv;

vv3=cat(2,vv1,vv2);

vp=totallVelocity_pdf(2e12,0.25);
...
grid;xlim([0.4 2.5]);ylim([0 4])
xlabelmine('$V/V_\mathrm{200}$');
ylabelmine('$P(V/V_\mathrm{200})$');
set(gca,'fontsize',14)
titlemine('$10^{12},\, <0.5$');
...
vv1=orbParam.mh5e12.mr005.vv;
vp=totallVelocity_pdf(5e12,0.025);
...
vv1=orbParam.mh1e13.mr05.vv;
vv2=orbParam.mh5e13.mr05.vv;

vv3=cat(2,vv1,vv2);

vp=totallVelocity_pdf(2e13,0.25);
...
vv1=orbParam.mh5e13.mr0005.vv;

vp=totallVelocity_pdf(5e13,0.0025);
len=50;
...
%vv1=orbParam.mh1e13.mr005.vv.*orbParam.mh1e13.v200c./orbParam.mh1e13.host.Vvir;
%vv2=orbParam.mh5e13.mr005.vv.*orbParam.mh5e13.v200c./orbParam.mh5e13.host.Vvir;
vv1=orbParam.mh1e13.mr005.vv;
vv2=orbParam.mh5e13.mr005.vv;
vv3=cat(2,vv1,vv2);

vp=totallVelocity_pdf(2e13,0.025);
...
vv1=orbParam.mh1e14.mr0005.vv;
vv2=orbParam.mh5e14.mr0005.vv;
vv3=orbParam.mh1e15.mr0005.vv;

vv4=cat(2,vv1,vv2,vv3);
vp=totallVelocity_pdf(2e14,0.0025);
...
vv1=orbParam.mh1e14.mr005.vv;
vv2=orbParam.mh5e14.mr005.vv;
vv3=orbParam.mh1e15.mr005.vv;

vv4=cat(2,vv1,vv2,vv3);

vp=totallVelocity_pdf(2e14,0.025);
...
vv1=orbParam.mh1e14.mr05.vv;
vv2=orbParam.mh5e14.mr05.vv;
vv3=orbParam.mh1e15.mr05.vv;

vv4=cat(2,vv1,vv2,vv3);

vp=totallVelocity_pdf(2e14,0.25);
