...
h(6)=plot(martina_ms,martina_qf,'-.','color',cmap(4,:),'linewidth',1.5,...
    'DisplayName','TNG300 direct Infall');
...
hl=legend(h);
set(hl,'Interpreter','latex','fontsize',16,'Location','SouthEast','NumColumns',2);
