...
if readFlag
    ...
    load(sprintf('%s/cooling_times_z0_%s.mat',DEFAULT_MATFILE_DIR,simDisplayName))
    load(sprintf('%s/BH_energyInjection_z0_%s.mat',DEFAULT_MATFILE_DIR,simDisplayName))
    
    if DRACOFLAG || snap~=99
...
% identify satellites and their centrals
centralList=subsInfo.hostCentral(tCoolStruct.galMask);
satMask= ~subsInfo.isCentral(tCoolStruct.galMask);
...
tvirMean=mk_meanMedian_bin(log10(galMass(satMask)),log10(tvir(satMask)),'nb',20);
...
xdata=log10(galMass(satMask));
ydata=log10(gasTemp(satMask));
popCont=plot_population_contour(xdata,ydata,'smooth',filt,'noplot','mask',ydata>0 & ~isinf(ydata));
yl=[4 8];
xl=[9 12.5];
...
figure
ax1=axes;
scatter(xdata,ydata,18,log10(ssfr(satMask)));
hold on
...
fname=sprintf('massTemp_%s_sats_%s','ssfr',simDisplayName);
printout_fig(gcf,fname);

% sfre
figure
ax1=axes;
scatter(xdata,ydata,18,log10(sfre(satMask)));
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','sfre',simDisplayName);
printout_fig(gcf,fname);
...
figure
ax1=axes;
scatter(xdata,ydata,18,log10(tc(satMask)));
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','tcool',simDisplayName);
printout_fig(gcf,fname);
...
figure
ax1=axes;
scatter(xdata,ydata,18,log10(fgs(satMask)));
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','mf',simDisplayName);
printout_fig(gcf,fname);

% QM
figure
ax1=axes;
scatter(xdata,ydata,18,log10(bhQM(centralList(satMask)+1)));
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','QMCentral',simDisplayName);
printout_fig(gcf,fname);

% KM
figure
ax1=axes;
scatter(xdata,ydata,18,log10(bhRM(centralList(satMask)+1)));
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','KMCentral',simDisplayName);
printout_fig(gcf,fname);

%RM/QM
figure
ax1=axes;
scatter(xdata,ydata,18,log10(bhRM(centralList(satMask)+1)./bhQM(centralList(satMask)+1)))
hold on
errorbar(tvirMean.xMedian,tvirMean.yMean,tvirMean.yStanDev/2,'-k','linewidth',1)
...
fname=sprintf('massTemp_%s_sats_%s','bhRatCEntral',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','ssfr',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','sfre',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','tcool',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','mf',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','QMCentral',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','KMCentral',simDisplayName);
printout_fig(gcf,fname);
...
fname=sprintf('massEnt_%s_sats_%s','bhRatCentral',simDisplayName);
printout_fig(gcf,fname);
