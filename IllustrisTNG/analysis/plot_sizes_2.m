...
h(3)=plot(hostMedR.xMedian,log10(hostMedR.yMean),'-k','linewidth',2,...
'DisplayName','$R_\mathrm{200,c}$');

%h(3)=errorbar(log10(hostMedR.xMedian),log10(hostMedR.yMean),hostMedR.yStanDev/2,'-k','linewidth',2,...
%'DisplayName','$R_\mathrm{200,c}$');
