...
%% make tracks between redshifts

% figure 
% for i=1:16
%     semilogx([mv_a06(i) mv_a1(i)],[edgerange_a1(i,1)./rv_a1(i) edgerange_a06(i,1)./rv_a06(i)],'g','linewidth',3.5)
%     hold on 
%     semilogx([mv_a06(i) mv_a1(i)],[edgerange_a1(i,2)./rv_a1(i) edgerange_a06(i,2)./rv_a06(i)],'g','linewidth',3.5)
%     
%     semilogx(mv_a1(i).*[1 1],edgerange_a1(i,:)./rv_a1(i),'b','linewidth',3.5)
%     semilogx(mv_a06(i).*[1 1],edgerange_a06(i,:)./rv_a06(i),'r','linewidth',3.5)
%     
