...
%         
        ...
        xc=0.05;
        yc=log10(TNG50(k).starMassC(i).yMedian);
        ycP=log10(TNG50(k).starMassC(i).yQuarts(2,:))-yc;
        ycN=yc-log10(TNG50(k).starMassC(i).yQuarts(2,:));
...
ylabelmine('log stellar mass');
 titlemine('TNG50 Median Stellar Mass ' );
 
%printout_fig(gcf,'median_stellarMass_radProf_TNG50','dir',outDir)
