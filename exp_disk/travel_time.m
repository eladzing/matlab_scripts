...
for i=1:16
    ...
    %hold on
    h(3)=loglog(clz0(i).mv,clz0(i).dt1,'ob',...
        'Markersize',12,'linewidth',1.5,...
        'DisplayName','$\mathrm{Shock}\to R_{\mathrm{vir}},\,z=0$');
    hold on
    h(4)=loglog(clz06(i).mv,clz06(i).dt1,'or',...
        'Markersize',12,'linewidth',1.5,...
        'DisplayName','$\mathrm{Shock}\to R_{\mathrm{vir}},\,z=0.6$');
...
hl=legend(h(3:6));
set(hl,'Fontsize',12,'Interpreter','latex','Location','NorthEast','box','on')
