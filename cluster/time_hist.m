...
%% read in data
[full_ff full_ro full_ts full_vr rp m200 r200 t200]=catspheres(halopath,smallbox,bigbox);   
...
ro=full_ro(innerr:outerr,:,:);
flx=full_ff(innerr:outerr,:,:);
vr=full_vr(innerr:outerr,:,:);
clear full_ts full_ro full_ff full_vr;

%% prepare radial mass profile
if innerr>1
...
%% calculate times
Ggrav=4.46e-15; %% in simulation units: Mpc, M_{sun}, Gyr 
zmet=1.;
