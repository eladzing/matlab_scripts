...
% ssfr
plot_massEnt2('tree',xdata,ydata,log10(ssfr(galaxyMask)),tre,ssfrLab,flipud(cmap),xl,yl,popCont,gasField,[-15 -9],hostMed)
...
% tcool
plot_massEnt2('tree',xdata,ydata,log10(tc(galaxyMask)),tre,tcLab,cmap,xl,yl,popCont,gasField,[-2.5 1.5],hostMed)
...
% gas density 
plot_massEnt2('tree',xdata,ydata,log10(gasDens(galaxyMask)),tre,densLab,cmap,xl,yl,popCont,gasField,[-4 -1],hostMed)
...
plot_massEnt2('tree',xdata,ydata,log10(tf),tre,temp2Lab,cmap,xl,yl,popCont,gasField,[-1 1],hostMed)
