...
%     edg2_a1(i,:)=shockedge_a1{i,5};%./rv_a1(i);
    ...
    mar(i)=log10(mv_a1(i)./mv_a06(i))./log10(a1/a2);

    
    for j=1:length(ed11)
        rv11(end+1)=rv_a1(i);
        mv11(end+1)=mar(i); %mv_a1(i);%./1e14;
        yy11(end+1)=ed11(j);
    end
...
mar=log10(mv_a1./mv_a06)./log10(a1/a2);
...
for i=1:16
           ...
           h(i)=plot(mar(i).*[1 1],edgerange_a1(i,:)./rv_a1(i),'linewidth',2,...
               'Color',map(i,:),'DisplayName',sprintf('CL%s',num2str(list(i))));
    
    
        hold on
   
    %plot(mv_a06(i).*[1 1],edgerange_a06(i,:)./rv_a06(i),'r','linewidth',3.5)
    %plot([mv_a06(i) mv_a1(i)],[edgemid_a06(i)./rv_a06(i) edgemid_a1(i)./rv_a1(i)],'g--','linewidth',1.5)
end
plot(mv11,zz11,'ob','markersize',9,'markerfacecolor','auto','linewidth',1.5)
plot(mv12,zz12,'db','markersize',9,'markerfacecolor','auto','linewidth',1.5)
%plot(mv_a1,edgemean_a1,'--')
%plot(mv61,zz61,'or','markersize',10.5,'markerfacecolor','auto')
%plot(mv62,zz62,'dr','markersize',10.5,'markerfacecolor','auto')
...
%     switch relist(i)
%         case 'u' 
%            h(1)=plot(mar(i).*[1 1],edgerange_a1(i,:)./rv_a1(i),'b','linewidth',2,'DisplayName','$z=0$');
%         case 'r'
%            plot(mar(i).*[1 1],edgerange_a1(i,:)./rv_a1(i),'b','linewidth',2)
%     end
%     if i==1
%         hold on
%     end
%    % h(2)=plot(mv_a06(i).*[1 1],edgerange_a06(i,:)./rv_a06(i),'r','linewidth',2,'DisplayName','$z=0$');
%    % plot([mv_a06(i) mv_a1(i)],[edgemid_a06(i)./rv_a06(i) edgemid_a1(i)./rv_a1(i)],'--','color',[0 0.75 0],'linewidth',1.5)
% end
% plot(mv11,zz11,'ob','markersize',9,'markerfacecolor','auto','linewidth',1.5)
% plot(mv12,zz12,'db','markersize',9,'markerfacecolor','auto','linewidth',1.5)
% %plot(mv_a1,edgemean_a1,'--')
% %plot(mv61,zz61,'or','markersize',9,'markerfacecolor','auto','linewidth',1.5)
% %plot(mv62,zz62,'dr','markersize',9,'markerfacecolor','auto','linewidth',1.5)
% 
% hold off
% %xlim([3e13 3e15])
% 
