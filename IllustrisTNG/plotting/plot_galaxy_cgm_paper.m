...
idList=[405568 441397 447153 554728 587022 595189 283637 284948 294510 ...
    296787 327405 347785 572671 585431 588650 594081 612501 ];
...
%  titleTag=['$' mgalText ',\,'  mhostText '\,\mathrm{M_\odot}$'];
  titleTag=['$M_\mathrm{gal}=' mgalText '\,\mathrm{M_\odot}$'];
...
thickness=2*rhalfGas;
    ...
    textS(3).str=titleTag;%   ['$' mgalText '\,\mathrm{M_\odot}$'];
...
%% stars
    ...
    textS(5).position=[-0.34*boxx/2 -0.87*boxx/2 ];
    textS(5).color='k';
    textS(5).fontsize=18;
...
illustris.plots.mkmapStars('star',stars,'type','mass','ng',ng,proj,...
    ...
    'zoom',rLimitOuter,'clims',caxStar,'circ',circ,'noticks','nogrid','barprop',barProp,'bartag',' ',...
...
illustris.plots.mkmapGas('gas',gas,'type','temp','ng',ng,proj,...
    ...
    'arrow',scaleArw,'noticks','labels','no','nogrid','barprop',barProp,'bartag',' ',...
    'print',printTag,'savefig','printoutdir',printoutDir);
...
illustris.plots.mkmapGas('gas',gas,'id',idGal,'r200',r200,'type','tctff','ng',ng,proj,...
    ...
    'text',textS([1 5]),'arrow',scaleArw,'noticks','labels','no','nogrid','barprop',barProp,'bartag',' ',...
    'print',printTag,'savefig','printoutdir',printoutDir);
...
textS(5).position=[0.0*boxx/2 -0.87*boxx/2 ];
...
illustris.plots.mkmapGas('gas',gas,'type','ndensity','ng',ng,proj,...
    ...
    'noticks','labels','no','nogrid','barprop',barProp,'bartag',' ',...
    'print',printTag,'savefig','printoutdir',printoutDir);
...
illustris.plots.mkmapGas('gas',gas,'type','entropy','ng',ng,proj,...
    ...
    'box',boxx,'zoom',rLimitOuter,'thick',thickness,'text',textS([1 5]),'arrow',scaleArw,...
    'noticks','labels','no','nogrid','barprop',barProp,'bartag',' ',...
    'print',printTag,'savefig','printoutdir',printoutDir);
...
textS(5).position=[-0.07*boxx/2 -0.87*boxx/2 ];
