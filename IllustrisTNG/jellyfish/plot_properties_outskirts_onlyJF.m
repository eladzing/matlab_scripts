...
outdir=[DEFAULT_PRINTOUT_DIR '/jellyfish/jfProperties/paper/outskirts'];
...
%            xl=xl0;yl=yl0;
            ...
            jfscore=rp(simMask & maskJF)'>=1;
            %jfscore=(simMask & maskJF & rp'>=1);
           ...
           % imagesc(xl,yl,squeeze(bird(:,:,1)))
            ...
            [~,h(1)]=contour(popContNJF.xx,popContNJF.yy,popContNJF.popContour,'ShowText','off',...  %'LineColor',[0 0 1],...
                ...
                'DisplayName','JF $<R_\mathrm{200,c}$');
             hold on
            ...
            [~,h(2)]=contour(popContJF.xx,popContJF.yy,popContJF.popContour,'ShowText','off','LineColor',[0 0 1],...
                ...
                'DisplayName','JF $\geq R_\mathrm{200,c}$');
           clabel([],h(2),'fontsize',14,'margin',5,'backgroundcolor','none');
            ...
            %% print figure
            fname=sprintf('jfProps_outSkirt_JF_%s_%s_%s',xfields{i},yfields{j},sims{k});
