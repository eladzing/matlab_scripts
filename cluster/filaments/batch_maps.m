...
printoutdir='C:\Users\eladzing\Documents\cluster\printout\filaments';

boxx=4;
for i=14:length(list)
    cl=list(i);
    new_env(cl);
    ...
    mkmap(boxx,'type','rho',prj,'clims',[7 14],'vfield','dilute',6,'thick',thick,...
        'marks',circ(2),'brewer',bmap,'labels','full','title','no',...
        'print','printag','fila','printoutdir',printoutdir,'png');
    
    mkmap(boxx,'type','numberdensity',prj,'clims',[-9 -2],'vfield','dilute',6,'thick',thick,...
        'marks',circ(2),'brewer',bmap,'labels','full','title','no',...
        'print','printag','fila','printoutdir',printoutdir,'png');
