...
if readFlag
    ...
    stars=illustris.snapshot.loadHalo(bp,snap,idGal,'stars',starFields);
...
illustris.plots.mkmapGas('gas',gas,'type','ndensity','ng',512,proj,...
    'mask',gasMask,'circ',circ,'clims',[-5 -1],'cmap',cmapDens,...%'vfield','dilute',6,'vcm',vcm,...
...
%
illustris.plots.mkmapGas('gas',gas,'type','entropy','ng',512,'xy',...%proj,...
    'mask',gasMask,'circ',circ,'clims',[-2 2],'cmap',flipud(cmapEnt),...
    'box',boxx,'zoom',rLimitOuter,'thick',0.5*thickness,...
