...
starMass(1)=mk_meanMedian_bin(radPosition(mask11),(massAllGals(mask11)),'bins',binEdges);
starMass(2)=mk_meanMedian_bin(radPosition(mask12),(massAllGals(mask12)),'bins',binEdges);
starMass(3)=mk_meanMedian_bin(radPosition(mask13),(massAllGals(mask13)),'bins',binEdges);
starMass(4)=mk_meanMedian_bin(radPosition(mask14),(massAllGals(mask14)),'bins',binEdges);
...
profStruct.maskStruct.mask11=mask11;
profStruct.maskStruct.mask12=mask12;
profStruct.maskStruct.mask13=mask13;
profStruct.maskStruct.mask14=mask14;

profStruct.maskStruct.cmask11=cmask11;
profStruct.maskStruct.cmask12=cmask12;
profStruct.maskStruct.cmask13=cmask13;
profStruct.maskStruct.cmask14=cmask14;

profStruct.ssfrAvg=ssfrAvg;
profStruct.ssfrAvgC=ssfrAvgC;
profStruct.starMass=starMass;
profStruct.starMassC=starMassC;

global DEFAULT_MATFILE_DIR
global simDisplayName
fname=[DEFAULT_MATFILE_DIR '/ssfr0_stellarMass_radProfiles_' simDisplayName];
